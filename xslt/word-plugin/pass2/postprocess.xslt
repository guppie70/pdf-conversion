...
<xsl:stylesheet version="3.0"
    ...
    <!-- Pass 2: Post-processing cleanup and asymmetric row detection.
         Operates on namespace-free intermediate result from Pass 1. -->
    ...
    <!-- Function to calculate effective cell count including colspan -->
    ...
    <!-- Helper function: check if row is a header row -->
    ...
    <xsl:template match="tbody" mode="pass2-tbody" priority="10">
        ...
        <!-- Check if first row is a title row (single cell with colspan) -->
        ...
        <!-- Identify consecutive header rows (after title, stop at first non-header) -->
