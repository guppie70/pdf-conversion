...
public class XmlFileWatcherService : IXmlFileWatcherService
{
    ...
    public event EventHandler<XmlFileChangedEventArgs>? FileChanged;

    /// <summary>
    /// Set a single callback for file changes (prevents double subscription from prerendering)
    /// </summary>
    public void SetFileChangedCallback(EventHandler<XmlFileChangedEventArgs>? callback)
    {
        _callback = callback;
    ...
    public void StartWatching(string filePath)
    {
        ...
        {
            _logger.LogWarning("XML file not found at {Path}, cannot start watching", filePath);
            return;
        }
        ...
        try
        {
            ...
            _logger.LogInformation("Started watching XML file: {Path}", filePath);
        }
        catch (Exception ex)
        {
    ...
    public void StopWatching()
    {
        if (_watcher != null)
        {
            ...
            _logger.LogInformation("Stopped watching XML file: {Path}", _currentFilePath);
        }
    ...
    public async Task<string> GetFileContentAsync()
    {
        ...
        {
            throw new FileNotFoundException("XML file not found", _currentFilePath);
        }
